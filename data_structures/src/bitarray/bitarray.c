...
bit_array_t BitArrSetOn(bit_array_t array, size_t index)
{
...
bit_array_t BitArrSetOff(bit_array_t array, size_t index)
{
...
bit_array_t BitArrSetBit(bit_array_t array, size_t index, int state)
{
...
bit_array_t BitArrFliptBit(bit_array_t array, size_t index)
{
...
bit_array_t BitArrRotR(bit_array_t array, size_t rotations)
{
...
bit_array_t BitArrRotL(bit_array_t array, size_t rotations)
{
	bit_array_t array_replica = array;
	rotations %= NUM_OF_BITS;
...
size_t BitArrCountOn(bit_array_t array) /* kernighan's way */
{
	size_t count_on = 0;
...
size_t BitArrCountOnLUT(bit_array_t array)
{
...
size_t BitArrCountOff(bit_array_t array)
{
	size_t count_on = 0;
...
int BitArrGetVal(bit_array_t array, size_t index)
{
...
bit_array_t BitArrMirrorLUT(bit_array_t array)
{
	...
	size_t shifts_remaining = NUM_OF_BITS;
